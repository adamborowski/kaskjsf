...
import pl.adamborowski.kask.jsf.entities.Library;
import pl.adamborowski.kask.jsf.entities.ObjectFactory;
...
public class BookService implements Serializable {
    ...
    public BookService() {
        ...
        try {
            ...
            Library library = (Library) u.unmarshal(getClass().getResourceAsStream("/pl/adamborowski/kask/jsf/xml/books.xml"));
